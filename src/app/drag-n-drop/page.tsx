          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-xl">
              <div className="flex items-center gap-2 mb-3 text-sm font-medium text-[#0f766e]">
                <MousePointerClick size={18} /> Drag and drop builder
              </div>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Design engaging email templates.</h2>
              <p className="text-gray-700 text-lg mb-6">
                Design captivating email templates with ease using our intuitive drag and drop builder.
              </p>

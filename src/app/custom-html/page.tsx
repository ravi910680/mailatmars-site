...
export default function DragNDropPage() {
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
    <div className="max-w-xl">
      ...
      <h2 className="text-4xl font-bold text-gray-900 mb-4">Code your email with full control.</h2>
      <p className="text-gray-700 text-lg mb-6">
        Edit your email templates using raw HTML with our built-in editor. Perfect for developers and advanced marketers.
      </p>
       <Link
    ...
    <Image
      src="/custom-html/img-1.png" // Ensure this file exists in your public folder
